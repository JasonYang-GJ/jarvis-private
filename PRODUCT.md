# 元枢产品事实（V0.5.0 / V2 阶段 3 冻结候选）

> 当前产品事实的唯一入口。更新时间：2026-08-30。S3-R1/R2/R3 已集成并通过离线 Release 门禁；当前源码版本为 V0.5.0，正式标签与标签源码产物身份将在最终冻结证据提交中回填。
...
- 阶段 3 版本为 V0.5.0；S3-R1/R2/R3 已集成，90/90 离线 Release 定向测试与实际 Release Client+Host 的本机 Fake Provider 桌面流程已通过。正式标签、安装包大小与 SHA-256 在两提交冻结的证据提交中回填。
